...
<div class="box">
		<div class="login-box">
			<div class="login-title text-center">
				<h1><small>绑定微信号</small></h1>
			</div>
			<div class="login-content ">
			<div class="form">
			<form action="${basepath }/user/querykey.action" method="post">
				...
				<div class="form-group form-actions">
					<div class="col-xs-4 col-xs-offset-4 ">
						<button id="but" type="submit" class="btn btn-sm btn-info">绑定</button><a href="${basepath }/register.jsp">未注册？注册去？</a>
					</div>
				</div>
			</form>
			</div>
