		...
		<div style="float:left;width:100%;text-align:center">
				<ul class="pagination">
					<c:if test="${requestScope.pager.hasFirst==true}">
						<li><a href="adminlist.action?currentPage=1">首页</a></li>
					</c:if>
					...
					<c:if test="${requestScope.pager.hasPrevious==true}">
						<li><a href="adminlist.action?currentPage=${requestScope.pager.currentPage-1}">上一页 </a></li>
					</c:if>
					...
					<c:if test="${requestScope.pager.hasNext==true}">
						<li><a href="adminlist.action?currentPage=${requestScope.pager.currentPage+1}">下一页 </a></li>
					</c:if>
					...
					<c:if test="${requestScope.pager.hasLast==true}">
						<li><a href="adminlist.action?currentPage=${requestScope.pager.totalPage}">尾页 </a></li>
					</c:if>
