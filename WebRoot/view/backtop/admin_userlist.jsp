            ...
            <div class="container-fluid">
                            ...
                            <table class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>${userList.comtype}</td>
                                        <td><a href="${basepath }/view/backtop/admin_setuser.jsp?userid=${userList.userid}&username=${userList.username}&password=${userList.password}&usertel=${userList.usertel}&comname=${userList.comname}&comtype=${userList.comtype}">修改</a>
                                    </tr>
                                </c:forEach>
                                </tbody>
                            </table>
				...
				<ul class="pagination">
					<c:if test="${requestScope.pager.hasFirst==true}">
						<li><a href="${basepath }/user/getAllUser.action?currentPage=1">首页</a></li>
					</c:if>
					...
					<c:if test="${requestScope.pager.hasPrevious==true}">
						<li><a
							href="${basepath }/user/getAllUser.action?currentPage=${requestScope.pager.currentPage-1}">
								上一页 </a></li>
					</c:if>
					...
					<c:if test="${requestScope.pager.hasLast==true}">
						<li><a
							href="${basepath }/user/getAllUser.action?currentPage=${requestScope.pager.totalPage}">
								尾页 </a></li>
					</c:if>
